...
- **Direct results:** Option/Alt-1 through Option/Alt-9 execute the first nine
  visible results without using browser-reserved Command/Control-number keys.
...
3. Use Arrow Up/Down, Control-N/P, or Control-J/K and Enter; press Option/Alt-1–9 to execute a numbered result directly; or click a result.
