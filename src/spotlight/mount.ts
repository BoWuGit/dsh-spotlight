...
[data-dsh-spotlight-option][aria-selected="true"] { background: color-mix(in srgb, var(--dsw-alias-brand-primary, #4d6bfe) 16%, transparent); }
...
[data-dsh-sidebar-shortcut] { position: absolute; min-width: 43px; padding: 3px 7px; transform: translate(-100%, -50%); border: 1px solid var(--dsw-alias-border-l1, rgba(0,0,0,.1)); border-radius: 7px; background: var(--dsw-alias-bg-layer-2, #fff); color: var(--dsw-alias-label-secondary, #777); box-shadow: 0 1px 4px rgba(0,0,0,.08); font: 500 12px/1 -apple-system, BlinkMacSystemFont, "SF Pro Text", "Segoe UI Symbol", sans-serif; font-variant-numeric: tabular-nums; text-align: center; }
...
[data-dsh-sidebar-onboarding] kbd { padding: 1px 4px; border: 1px solid var(--dsw-alias-border-l1, rgba(0,0,0,.1)); border-radius: 5px; background: var(--dsw-alias-bg-layer-1, rgba(0,0,0,.04)); color: var(--dsw-alias-label-primary, #222); font: 500 11px/1 -apple-system, BlinkMacSystemFont, "SF Pro Text", "Segoe UI Symbol", sans-serif; font-variant-numeric: tabular-nums; }
